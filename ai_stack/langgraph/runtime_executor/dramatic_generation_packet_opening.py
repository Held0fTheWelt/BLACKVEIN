"""Dramatic packet opening context.

Starts dramatic generation packet assembly with opening-turn state, module policy, scene identity, and baseline runtime context.
"""
SOURCE_LINES = [
