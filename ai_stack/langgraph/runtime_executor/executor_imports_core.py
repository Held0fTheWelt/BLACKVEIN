...
Holds the base imports, shared typing, logging, model registry, retrieval, capability, and runtime-contract dependencies required before any executor helpers are defined.
"""
SOURCE_LINES = [
    '"""\n',
