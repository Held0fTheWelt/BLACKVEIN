"""Actor-lane structured output validation.

Validates responder ids, spoken lines, action lines, and initiative events against the legal actor scope derived from director and character-mind state.
"""
SOURCE_LINES = [
    '        }\n',
    '\n',
