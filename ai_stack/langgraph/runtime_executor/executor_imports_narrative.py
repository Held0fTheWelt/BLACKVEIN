"""Narrative dependency surface.

Continues the import surface for narrative engines, God of Carnage authority data, director contracts, semantic planners, runtime state, validation helpers, and language adapters.
"""
SOURCE_LINES = [
