"""Director routing requirements.

Defines drama-aware routing requirements and destination context blocks used before gathering actors and selecting director parameters.
"""
SOURCE_LINES = [
