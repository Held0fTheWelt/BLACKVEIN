"""Runtime dispatch and voice aspects.

Connects runtime graph dispatch context with voice consistency, voice semantic failure detection, and scene-energy aspect construction.
"""
SOURCE_LINES = [
