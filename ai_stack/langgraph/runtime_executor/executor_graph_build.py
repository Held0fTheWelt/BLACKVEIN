...
Defines executor initialization and graph wiring, including the route from input interpretation through retrieval, action resolution, model invocation, validation, commit, render, and packaging.
"""
SOURCE_LINES = [
    '@dataclass\n',
