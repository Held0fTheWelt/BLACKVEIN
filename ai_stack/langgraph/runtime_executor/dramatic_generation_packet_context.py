"""Dramatic packet narrative context.

Adds narrative context, retrieval continuity, relationship dynamics, character state, and semantic planning inputs to the generation packet.
"""
SOURCE_LINES = [
    '        )\n',
