"""Input interpretation setup.

Begins _interpret_input by preparing raw player input, semantic contracts, language surfaces, and model-assisted interpretation state.
"""
SOURCE_LINES = [
