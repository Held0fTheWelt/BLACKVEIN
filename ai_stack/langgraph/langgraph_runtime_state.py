...
class RuntimeTurnState(TypedDict, total=False):
    ...
    opening_quote_anchors: dict[str, Any]
    hard_forbidden_rules: dict[str, Any]
    canonical_path: dict[str, Any]
    modularity_policy: dict[str, Any]
    ...
    prior_narrative_momentum_state: dict[str, Any]
    prior_genre_awareness_state: dict[str, Any]
    prior_symbolic_object_resonance_state: dict[str, Any]
    ...
    symbolic_object_resonance_state: dict[str, Any]
    symbolic_object_resonance_target: dict[str, Any]
    symbolic_object_resonance_validation: dict[str, Any]
    ...
    narrative_momentum_state: dict[str, Any]
    narrative_momentum_target: dict[str, Any]
    narrative_momentum_validation: dict[str, Any]
    genre_awareness_state: dict[str, Any]
    genre_awareness_target: dict[str, Any]
    genre_awareness_validation: dict[str, Any]
