...
from ai_stack.story_runtime.npc_agency.goc_npc_transcript_projection import goc_spoken_lines_multi_speaker_row_markers
...
from ai_stack.story_runtime.turn.goc_turn_seams_validation import (
