...
Extracted from ``goc_turn_seams`` so commit/visible seams stay in the orchestration module
...
from ai_stack.goc_frozen_vocab import GOC_MODULE_ID, canonicalize_goc_actor_id, expand_goc_actor_id_aliases
