...
from ai_stack.story_runtime.god_of_carnage.god_of_carnage_dramatic_alignment import _GENERIC_BOILERPLATE_PHRASES, dramatic_alignment_structural_fallback_only
