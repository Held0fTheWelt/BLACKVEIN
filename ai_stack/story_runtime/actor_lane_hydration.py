"""Hydrate narrative-only structured output into actor-turn lanes.
...
def should_hydrate_actor_lanes(
...
def hydrate_actor_lanes(
    ...
    *,
    ...
    if not should_hydrate_actor_lanes(
        structured_output,
...
def apply_structured_hydration(
    state: dict[str, Any],
    ...
    if (
        ...
        and should_hydrate_actor_lanes(
            cleaned,
            module_id=GOC_MODULE_ID,
        ...
        cleaned, actor_changed = hydrate_actor_lanes(
            cleaned,
