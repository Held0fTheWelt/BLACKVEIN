...
from ai_stack.story_runtime.npc_agency.character.character_mind_goc import resolve_runtime_actor_id
from ai_stack.story_runtime.npc_agency.character.character_voice_contract import CharacterVoiceProfileRecord
