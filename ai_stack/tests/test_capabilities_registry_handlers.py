...
class TestResearchSourceInspectHandler:
    ...
    def test_successful_source_inspection(self):
        ...
        with patch("ai_stack.research.research_langgraph.inspect_source") as mock_inspect:
...
class TestResearchClaimListHandler:
    ...
    def test_list_all_claims(self):
        ...
        with patch("ai_stack.research.research_langgraph.list_claims") as mock_list:
...
class TestResearchRunGetHandler:
    ...
    def test_get_valid_run(self):
        ...
        with patch("ai_stack.research.research_langgraph.get_run") as mock_get:
...
class TestResearchExplorationGraphHandler:
    ...
    def test_exploration_graph_retrieval(self):
        ...
        with patch("ai_stack.research.research_langgraph.exploration_graph") as mock_graph:
...
class TestCanonIssueInspectHandler:
    ...
    def test_inspect_canon_issues(self):
        ...
        with patch("ai_stack.research.research_langgraph.inspect_canon_issue") as mock_inspect:
            mock_inspect.return_value = {
                "issues": [
...
class TestResearchBundleBuildHandler:
    ...
    def test_build_bundle_success(self):
        ...
        with patch("ai_stack.research.research_langgraph.build_research_bundle") as mock_build:
...
class TestCanonImprovementProposeHandler:
    ...
    def test_propose_improvements(self):
        ...
        with patch("ai_stack.research.research_langgraph.propose_canon_improvement") as mock_propose:
...
class TestCanonImprovementPreviewHandler:
    ...
    def test_preview_improvements(self):
        ...
        with patch("ai_stack.research.research_langgraph.preview_canon_improvement") as mock_preview:
...
class TestHandlerDispatchIntegration:
    ...
    def test_error_propagation_through_handlers(self):
        ...
        error_cases = [
            (research_source_inspect_handler, {"source_id": "bad"}, "ai_stack.research.research_langgraph.inspect_source"),
            (research_run_get_handler, {"run_id": "bad"}, "ai_stack.research.research_langgraph.get_run"),
            (canon_issue_inspect_handler, {"module_id": "bad"}, "ai_stack.research.research_langgraph.inspect_canon_issue"),
        ]
