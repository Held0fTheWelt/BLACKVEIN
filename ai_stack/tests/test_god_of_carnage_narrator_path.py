...
def test_god_of_carnage_narrator_path_director_plan_skips_actor_lanes() -> None:
    out = god_of_carnage_narrator_path.build_goc_narrator_path_opening(session_output_language="en")
...
def test_god_of_carnage_narrator_path_projects_mandatory_beat_content(monkeypatch) -> None:
    synthetic_path = {
    ...
    monkeypatch.setattr(god_of_carnage_narrator_path, "load_goc_canonical_path_yaml", lambda: synthetic_path)
