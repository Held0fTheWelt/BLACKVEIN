"""Extended tests for god_of_carnage_scene_director.py — decision paths and edge cases (95%+ coverage)."""
...
class TestSeverityIndex:
    ...
    def test_severity_index_valid_class(self):
        ...
        from ai_stack.story_runtime.director.god_of_carnage_scene_director import _severity_index
...
class TestGocPrimaryResponderFromContext:
    ...
    def test_responder_from_actor_hint(self):
        ...
        from ai_stack.story_runtime.director.god_of_carnage_scene_director import _goc_primary_responder_from_context
...
class TestYamlDefaultResponder:
    ...
    def test_responder_repair_attempt_continuity(self):
        ...
        from ai_stack.story_runtime.director.god_of_carnage_scene_director import _yaml_default_responder
