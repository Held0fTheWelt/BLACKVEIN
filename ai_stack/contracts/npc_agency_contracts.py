...
NPC_LONG_HORIZON_STATE_SCHEMA_VERSION = "npc_long_horizon_state.v1"
NPC_INTENTION_THREAD_SCHEMA_VERSION = "npc_intention_thread.v1"
NPC_INTENTION_THREAD_ACTIVE_STATUS = "active"
NPC_INTENTION_THREAD_CLOSED_STATUS = "closed"
NPC_PRIVATE_PLAN_SCHEMA_VERSION = "npc_private_plan.v1"
NPC_PRIVATE_PLAN_VISIBILITY_RESOLVER_MAY_SURFACE = "resolver_may_surface_visible_lane"
NPC_PLAN_CONFLICT_RESOLUTION_SCHEMA_VERSION = "npc_plan_conflict_resolution.v1"
NPC_PLAN_CONFLICT_RESOLUTION_POLICY_REQUIRED_FIRST = "required_first_then_primary_then_priority"
NPC_AGENCY_CLAIM_READINESS_SCHEMA_VERSION = "npc_agency_claim_readiness.v1"
NPC_AGENCY_CLAIM_BOUNDED_RUNTIME_STATUS = "bounded_runtime_simulation"
NPC_AGENCY_CLAIM_LIVE_STAGING_READY_STATUS = "live_staging_ready"
NPC_AGENCY_CLAIM_FULL_LONG_HORIZON_READY_STATUS = "full_long_horizon_ready"
...
NPC_AGENCY_CLOSURE_SUPERSEDED_STATUS = "superseded"
NPC_AGENCY_CLOSURE_BLOCKED_BY_PLAYER_ACTION_STATUS = "blocked_by_player_action"
NPC_AGENCY_CLOSURE_EXPIRED_BY_SCENE_TRANSITION_STATUS = "expired_by_scene_transition"
