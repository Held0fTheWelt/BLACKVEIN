"""
``ai_stack/capabilities/capabilities.py`` — expand purpose, primary entrypoints, and
...
from ai_stack.capabilities.capabilities_invocation_summaries import summarize_invocation_result as _summarize_invocation_result
...
def __getattr__(name: str) -> Any:
    ...
    if name == "create_default_capability_registry":
        from ai_stack.capabilities.capabilities_default_registry import create_default_capability_registry as _factory
