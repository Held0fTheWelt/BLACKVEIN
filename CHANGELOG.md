...
### Added
- **Phase 10 (cleanup and consistency):** Replaced remaining editor references with moderator in BackendApi.md (News section), wiki.md, runbook.md, LocalDevelopment.md. No code or behavior change; docs and content aligned with final role model (user, moderator, admin).
