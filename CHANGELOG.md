...
- **Contractify hub (repository contract governance):** installable Python package **`contractify`** under [`'fy'-suites/contractify/`]('fy'-suites/contractify/__init__.py) with [`contractify.tools.hub_cli`]('fy'-suites/contractify/tools/hub_cli.py) (subcommands **`discover`**, **`audit`**, **`self-check`**), [`contractify.tools.discovery`]('fy'-suites/contractify/tools/discovery.py) (explicit A–E heuristics and `discovery_reason` per candidate), [`contractify.tools.drift_analysis`]('fy'-suites/contractify/tools/drift_analysis.py) (deterministic OpenAPI SHA vs [`postman/postmanify-manifest.json`](postman/postmanify-manifest.json), heuristic projection back-reference hints, Docify scan-root handoff, Despaghettify setup JSON presence), [`contractify.tools.audit_pipeline`]('fy'-suites/contractify/tools/audit_pipeline.py), [`contractify.tools.repo_paths`]('fy'-suites/contractify/tools/repo_paths.py), and [`python -m contractify.tools`]('fy'-suites/contractify/tools/__main__.py); root [`pyproject.toml`](pyproject.toml) exposes the **`contractify`** console script.
...
- **Contractify unit tests:** [`'fy'-suites/contractify/tools/tests/`]('fy'-suites/contractify/tools/tests/__init__.py) (automation tiers, discovery smoke, Postman manifest drift, hub **`discover --out`**).
...
- **Contractify hub tools:** `python -m pytest "'fy'-suites/contractify/tools/tests" -q` (from repo root, after **`pip install -e .`**) — six tests; local audit JSON under **`'fy'-suites/contractify/reports/*.json`** is gitignored to avoid committing machine-generated drift snapshots.
