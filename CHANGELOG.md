...
- **Audit closure H2 / H3 / M2 / L1:** [ADR-0002](docs/governance/adr-0002-backend-session-surface-quarantine.md) **Accepted** with Appendix A inventory + retirement **decision gate**; [ADR-0003](docs/governance/adr-0003-scene-identity-canonical-surface.md) **Accepted** with **Option A** source-of-truth in [`ai_stack/goc_scene_identity.py`](ai_stack/goc_scene_identity.py), [`ai_stack/tests/test_goc_scene_identity.py`](ai_stack/tests/test_goc_scene_identity.py), and [`tools/verify_goc_scene_identity_single_source.py`](tools/verify_goc_scene_identity_single_source.py) (CI in [`.github/workflows/ai-stack-tests.yml`](.github/workflows/ai-stack-tests.yml)); **supported test invocation matrix** in [`docs/dev/contributing.md`](docs/dev/contributing.md), root [`Makefile`](Makefile), and [`scripts/run_*`](scripts/); state **Part L1** frozen criteria and findings F-L1a / F-L1b in [`audit_resolution_state_world_of_shadows.md`](docs/governance/audit_resolution/audit_resolution_state_world_of_shadows.md).
