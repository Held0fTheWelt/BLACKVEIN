...
- **LangGraph research pipeline phases:** [`ai_stack/research_langgraph_run_pipeline_phases.py`](ai_stack/research_langgraph_run_pipeline_phases.py) plus refactor of [`research_langgraph.py`](ai_stack/research_langgraph.py) to delegate phase work.
...
- **LangGraph dramatic review section (hub wave DS-026):** [`ai_stack/langgraph_runtime_package_output_dramatic_review.py`](ai_stack/langgraph_runtime_package_output_dramatic_review.py) — helper functions plus `build_dramatic_review_section`; [`ai_stack/langgraph_runtime_package_output_sections.py`](ai_stack/langgraph_runtime_package_output_sections.py) re-exports for [`langgraph_runtime_package_output.py`](ai_stack/langgraph_runtime_package_output.py).
...
- **`ai_stack/scene_director_goc.py`**: Earlier Phase 5 heuristic trace and nudge work; this behavior was later superseded by semantic move payload routing.
...
- **`ai_stack/scene_director_goc.py`**: Earlier deterministic move-recognition expansion for the GoC MVP slice; later superseded by semantic move payload routing while retaining frozen scene-function vocabulary.
