...
- `extract_function` → `coda/tools/assembly.py` (high)
...
- `split_file` → `contractify/tools/runtime_mvp_spine.py` (high)
- `extract_function` → `contractify/tools/runtime_mvp_spine.py` (high)
...
- `split_file` → `diagnosta/tools/analysis.py` (high)
...
- `fy_platform/ai/candidate_e_reporting.py` → `mixed_responsibility_module` (medium)
...
- `fy_platform/ai/schemas/common_records.py` → `mixed_responsibility_module` (medium)
