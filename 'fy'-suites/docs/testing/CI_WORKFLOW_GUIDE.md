...
### 6. FY Suite Governance Workflows

Additional repository governance workflows validate the hub suites themselves:

- `.github/workflows/dockerify-skills-validate.yml`
- `.github/workflows/testify-skills-validate.yml`
- `.github/workflows/documentify-skills-validate.yml`

These jobs ensure the suite CLIs, reports, and unit tests remain runnable after repository changes.
