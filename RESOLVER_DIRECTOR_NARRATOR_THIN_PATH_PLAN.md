...
| A-10 | Live-Smoke (5 Inputs) | partial | Erster Smoke: Pfad läuft, LLM produziert DE-Output, 12 Knoten statt 30+. Erkannte Folge-Probleme behoben in A-12. Re-Smoke ausstehend. |
| A-11 | Diagnose-Anzeige `realization_plan` | partial | Felder in `path_summary` durchgereicht: `realization_plan`, `realize_via_capabilities_used_capability`, `realize_via_capabilities_outcome`, `kanon_break`, `kanon_break_reason`, `director_path_mode="director_realization_composer"` als Fallback. `narrative_systems.html`-Erweiterung steht noch aus. (`world-engine/app/story_runtime/manager.py:3333-3358`) |
