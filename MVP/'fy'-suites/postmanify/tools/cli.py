#!/usr/bin/env python3
"""Postmanify — generate Postman collections from OpenAPI (master + per-tag sub-suites)."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    Module context: ``'fy'-suites/postmanify/tools/cli.py`` — keep this routine aligned with
    sibling helpers in the same package.
