#!/usr/bin/env python3
"""Walk a Python package and apply draft Google-style module/class/function docstrings.

Edits one symbol per re-parse (bottom-up by ``lineno``) so line numbers stay valid.
Skips nested functions and methods defined inside another function body.
