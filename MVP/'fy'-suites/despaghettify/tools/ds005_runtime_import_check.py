...
Run from repository root:
  python "./'fy'-suites/despaghettify/tools/ds005_runtime_import_check.py"
...
def main() -> int:
    ...
    Module context: ``'fy'-suites/despaghettify/tools/ds005_runtime_import_check.py`` — keep
    this routine aligned with sibling helpers in the same package.
