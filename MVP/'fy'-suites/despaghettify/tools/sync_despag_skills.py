...
Canonical sources: ``<hub>/superpowers/<skill-name>/SKILL.md`` (hub lives under ``'fy'-suites/despaghettify/``).
Targets: ``.cursor/skills/<skill-name>/SKILL.md``

Run from repository root after editing any hub skill (``pip install -e .`` optional; else see bootstrap in this file):
...
def sync(*, check_only: bool) -> int:
    ...
    Module context: ``'fy'-suites/despaghettify/tools/sync_despag_skills.py`` — keep this
