...
def test_pr_0_piv_artifact_required_sections() -> None:
    ...
    for verified_anchor in (
        ...
        "ai_stack/langgraph_runtime_executor.py:3996",
        "ai_stack/langgraph_runtime_executor.py:4703",
        "ai_stack/scene_director_goc.py:655",
...
def test_runtime_diagnostic_snapshot_v1_envelope_shape_exists() -> None:
    from ai_stack.runtime_diagnostic_snapshot_contracts import (
...
RUNTIME_FILES_UNTOUCHED_BY_PR_0 = (
    ...
    "ai_stack/narrator_consequence_contracts.py",
