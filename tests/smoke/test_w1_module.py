"""
Smoke tests for W1 God of Carnage module structure.

Validates that the God of Carnage module is:
- Structurally valid YAML
- Complete (all required files present)
- Internally consistent (character refs, relationship refs, etc.)
- Aligned with W0 contract specifications
"""
...
class TestW1ModuleNoWaveReferences:
