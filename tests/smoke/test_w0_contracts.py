...
class TestW0ContractDocs:
    """Validate W0 contract documents exist and are non-empty."""

    def test_mvp_definition_exists(self):
        """MVP Definition contract document exists."""
    ...
    def test_god_of_carnage_contract_exists(self):
        """God of Carnage Module contract document exists."""
    ...
    def test_ai_story_contract_exists(self):
        """AI Story contract document exists."""
    ...
    def test_session_runtime_contract_exists(self):
        """Session Runtime contract document exists."""
...
class TestW0Schemas:
    ...
    def _assert_schema_valid(self, schema, require_required=True):
        """Assert schema has required top-level structure."""
    ...
    def test_content_module_schema_exists(self):
        """Content module schema exists and is valid JSON."""
    ...
    def test_ai_story_output_schema_exists(self):
        """AI story output schema exists and is valid JSON."""
    ...
    def test_session_state_schema_exists(self):
        """Session state schema exists and is valid JSON."""
    ...
    def test_state_delta_schema_exists(self):
        """State delta schema exists and is valid JSON."""
