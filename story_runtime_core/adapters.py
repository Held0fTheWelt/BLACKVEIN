...
class BaseModelAdapter:
    ...
    def generate(self, prompt: str, *, timeout_seconds: float = 10.0) -> ModelCallResult:
...
class MockModelAdapter(BaseModelAdapter):
    ...
    def generate(self, prompt: str, *, timeout_seconds: float = 10.0) -> ModelCallResult:
        return ModelCallResult(
            ...
            success=True,
            metadata={"adapter": self.adapter_name, "timeout_seconds": timeout_seconds},
        )
...
class OpenAIChatAdapter(BaseModelAdapter):
    ...
    def generate(self, prompt: str, *, timeout_seconds: float = 20.0) -> ModelCallResult:
