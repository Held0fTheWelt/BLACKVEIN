...
MCP_DEFAULT_TOOL_DESCRIPTIONS: dict[str, str] = {
    ...
    "wos.session.create": "Create or resume a canonical player session through /api/v1/game/player-sessions",
    ...
    "wos.session.get": "Canonical player-session snapshot by run_id",
    "wos.session.execute_turn": "Execute turn via /api/v1/game/player-sessions/<run_id>/turns",
    "wos.session.logs": "Player-session story entries by run_id",
    "wos.session.state": "Player-session shell state by run_id",
    "wos.session.diag": "World-Engine story-session evidence by runtime_session_id or run_id",
...
MCP_DEFAULT_TOOL_INPUT_SCHEMAS: dict[str, dict[str, Any]] = {
    ...
    "wos.session.create": {
        ...
        "properties": {
            ...
            "selected_player_role": {"type": "string"},
            "session_input_language": {"type": "string"},
            "session_output_language": {"type": "string"},
        },
        "required": [],
    },
    ...
    "wos.session.diag": {
        ...
        "properties": {
            ...
            "story_session_id": {"type": "string"},
            "world_engine_story_session_id": {"type": "string"},
        },
        "required": [],
    },
    "wos.session.get": {
        "type": "object",
        "properties": {"session_id": {"type": "string"}, "run_id": {"type": "string"}},
        "required": [],
    },
    "wos.session.logs": {
        "type": "object",
