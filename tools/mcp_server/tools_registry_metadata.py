...
MCP_DEFAULT_TOOL_DESCRIPTIONS: dict[str, str] = {
    ...
    "summarize_runtime_aspect_matrix": "Summarize backend-owned RuntimeAspectLedger evidence across Langfuse turn traces (world-engine.turn.execute plus backend.turn.execute roots on the same distributed trace)",
