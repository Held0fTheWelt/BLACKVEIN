...
class TestSessionOutputLanguage:
    ...
    def test_create_story_session_defaults_to_module_language_when_omitted(self, client, internal_api_key):
        """Omitted output language defaults to the module authoring language."""
        response = client.post(
            "/api/story/sessions",
            headers={"X-Play-Service-Key": internal_api_key},
            json={
