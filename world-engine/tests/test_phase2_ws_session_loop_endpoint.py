...
and ai_stack/story_runtime/ws_session_loop helpers). The turn-execution layer is
...
def autonomous_enabled(monkeypatch):
    from ai_stack.story_runtime.autonomous_tick import PHASE2_AUTONOMOUS_TICK_ENABLED
...
def autonomous_pause_loop_enabled(monkeypatch):
    from ai_stack.story_runtime.autonomous_tick import PHASE2_AUTONOMOUS_PAUSE_LOOP_ENABLED
