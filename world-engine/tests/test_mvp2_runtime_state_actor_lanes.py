...
def test_actor_lane_validation_runs_before_response_packaging():
    ...
    from ai_stack.story_runtime.turn.god_of_carnage_turn_seams import run_commit_seam, run_validation_seam, run_visible_render
...
def test_actor_lane_validation_runs_before_commit():
    ...
    from ai_stack.story_runtime.turn.god_of_carnage_turn_seams import run_commit_seam, run_validation_seam
