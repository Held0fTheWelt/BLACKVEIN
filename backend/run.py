        ...
        entries = [
            {
                ...
                "summary": "We are pleased to announce the World of Shadows project – a dark foundation for the world of Better Tomorrow.",
                "content": "World of Shadows is now in active development. This project will serve as the backbone for the Better Tomorrow experience: account and auth, news, and later game services. Stay tuned for development updates and feature announcements.",
            ...
            {
                "title": "The World of Better Tomorrow",
                "slug": "world-of-better-tomorrow",
                "summary": "A short introduction to the world behind World of Shadows.",
                "content": "Better Tomorrow is the world in which the shadows gather. Be the darkness, not the prey. This lore will expand as development continues. For now, the foundation is being laid: identity, news, and the first steps toward the full experience.",
                "category": "Lore",
                "is_published": True,
            },
            {
