"""Phasen-Helfer für finalize_improvement_experiment_capability_phase (DS-009)."""
...
def invoke_governance_review_bundle(
    *,
    package_response: dict[str, Any],
...
def _retrieval_hit_count(evidence_sources: list[str], retrieval_inner: Any) -> int:
...
def apply_rationale_strength_and_final_evidence_bundle(
    package_response: dict[str, Any],
    *,
    ...
    hit_count = _retrieval_hit_count(evidence_sources, retrieval_inner)
...
def enrich_validate_and_store_package(
    package_response: dict[str, Any],
    *,
    context_payload: dict[str, Any],
    experiment: dict[str, Any],
