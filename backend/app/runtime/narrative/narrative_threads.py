...
from app.runtime.narrative.narrative_state_transfer_dto import NarrativeCommitEvent
...
def update_narrative_threads_from_commit(
    ...
    *,
    ...
    """
    from app.runtime.narrative.narrative_threads_update_from_commit import update_narrative_threads_from_commit_impl
