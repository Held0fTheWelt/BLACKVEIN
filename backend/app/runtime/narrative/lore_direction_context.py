...
from app.runtime.narrative.lore_direction_context_types import LoreDirectionContext, ModuleGuidanceUnit
from app.runtime.narrative.narrative_threads import NarrativeThreadSet
...
def derive_lore_direction_context(
    ...
    """
    from app.runtime.narrative.lore_direction_context_derivation import assemble_lore_direction_context_payload
