"""routing governance — deterministic operational/bootstrap state and no-eligible discipline."""
...
class OperationalState(str, Enum):
    """Process-level operational/bootstrap health for routing governance (mutually exclusive)."""
...
def classify_operational_state(
    *,
    ...
    """Derive a single OperationalState from explicit facts (no telemetry).
