...
``from app.runtime.transitional import turn_executor`` loads ``app.runtime.turn.turn_executor``.
...
from app.runtime.package_classification import TRANSITIONAL_RUNTIME_MODULE_NAMES, runtime_module_import_path
...
def __getattr__(name: str) -> Any:
    ...
    return importlib.import_module(runtime_module_import_path(name))
