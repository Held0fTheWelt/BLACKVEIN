...
from app.runtime.validation.reference_policy import ReferencePolicy
from app.runtime.scene_legality import SceneTransitionLegality
from app.runtime.validation.validators_action_structure import collect_action_structure_errors
...
def _validate_delta(delta: Any, session: Any, module: Any) -> list[str]:
    ...
    # =========================================
    from app.runtime.validation.mutation_policy import MutationPolicy
