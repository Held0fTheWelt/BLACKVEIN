...
from app.runtime.ai_turn.ai_turn_orchestration_logging import (
    attachments_from_orchestration_bundle,
    build_turn_orchestration_attachments,
)
from app.runtime.ai_turn.ai_turn_preview import build_preview_diagnostics_payload, set_preview_improvement_metric
from app.runtime.ai_turn.ai_turn_shared_types import _AiTurnOrchestrationLogBundle
from app.runtime.ai_turn.ai_turn_recovery_state import activate_degraded_marker as _activate_degraded_marker
from app.runtime.ai_turn.ai_turn_recovery_state import store_decision_log
...
from app.runtime.turn.tool_loop import ToolLoopStopReason
...
async def _execute_fallback_responder_recovery(
    *,
    ...
    from app.runtime.ai.ai_failure_recovery import generate_fallback_responder_proposal
...
async def handle_generation_failure_or_empty(
    *,
    ...
    from app.runtime.ai_turn.ai_turn_recovery_generation_failure_exhausted import (
