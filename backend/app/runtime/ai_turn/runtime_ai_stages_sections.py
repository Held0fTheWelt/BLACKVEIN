...
from app.runtime.ai.ai_failure_recovery import AIFailureClass, RetryPolicy
...
from app.runtime.routing.operator_audit import build_runtime_operator_audit, runtime_additive_orchestration_fields
...
def run_preflight_signal_ranking_gate(
    *,
    ...
    ras = import_module("app.runtime.ai_turn.runtime_ai_stages")
