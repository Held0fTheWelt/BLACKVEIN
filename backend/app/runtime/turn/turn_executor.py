...
from app.runtime.narrative.narrative_commit import narrative_commit_for_source_gate_rejection
...
from app.runtime.narrative.short_term_context import build_short_term_context
from app.runtime.turn.turn_executor_decision_delta import (
...
def _derive_runtime_context(
    ...
    from app.runtime.narrative.progression_summary import derive_progression_summary
...
def _execute_turn_validated_pipeline(
    ...
    from app.runtime.turn.turn_executor_validated_pipeline import run_validated_turn_pipeline
