...
from app.runtime.routing.operational_state import OperationalState, pytest_session_active
...
def expected_operational_state_for_profile(
    ...
    *,
    ...
    from app.runtime.routing.operational_state import classify_operational_state
