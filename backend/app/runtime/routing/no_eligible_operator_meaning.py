"""routing governance — compact ``no_eligible_operator_meaning`` payload (flat decision tree)."""

from __future__ import annotations

from typing import Any

from app.runtime.routing.operational_state import OperationalState
...
def build_no_eligible_operator_meaning_payload(
    *,
    ...
    elif operational_state is OperationalState.misconfigured:
        token = "operational_misconfigured_registry_or_inventory"
    elif operational_state is OperationalState.intentionally_degraded:
    ...
    applicable = (
        operational_state is not OperationalState.healthy
        or bool(stages_nea)
