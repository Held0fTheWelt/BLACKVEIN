...
from app.services.content.news_service_create_guards import validate_news_create_payload
from app.services.content.news_service_translation_upsert_guards import (
    validate_upsert_translation_create_fields,
    validate_upsert_translation_update_patch,
)
from app.services.content.news_service_update_guards import validate_news_update_patch
...
def get_suggested_threads_for_article(article_id: int, *, limit: int = 5) -> list[dict]:
    ...
    from app.services.content.forum_service import suggest_related_threads_for_query
