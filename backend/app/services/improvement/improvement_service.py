...
from app.contracts.improvement_operating_loop import IMPROVEMENT_OPERATING_LOOP_CONTRACT_VERSION
from app.contracts.writers_room_artifact_class import (
    GOC_SHARED_SEMANTIC_CONTRACT_VERSION,
    WritersRoomArtifactClass,
)
from app.services.improvement.improvement_constants import IMPROVEMENT_PUBLICATION_CONTRACT_VERSION  # noqa: F401
from app.services.improvement.improvement_store import (  # noqa: F401
    ImprovementStore,
...
def apply_improvement_recommendation_decision(
    *,
    ...
    """
    from app.services.improvement.improvement_service_recommendation_decision import (
        apply_improvement_recommendation_decision as _apply_improvement_recommendation_decision,
    )

    return _apply_improvement_recommendation_decision(
        package_id=package_id,
        actor_id=actor_id,
        decision=decision,
        note=note,
