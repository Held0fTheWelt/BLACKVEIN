...
from app.services.ai_stack.ai_stack_evidence_service import build_release_readiness_report
from app.services.governance.diagnosis_gates_mapping_service import enrich_diagnosis_with_gates
from app.services.game.game_content_service import list_published_experience_payloads
from app.services.game.game_service import has_complete_play_service_config
from app.services.system.system_diagnosis_play_http import (
...
def _check_storage_layer_encryption() -> dict[str, Any]:
    t0 = time.perf_counter()
    try:
        from app.services.governance.security_governance_service import get_security_governance
