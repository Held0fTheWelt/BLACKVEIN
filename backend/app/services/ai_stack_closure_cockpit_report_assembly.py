...
def assemble_closure_cockpit_report(
    *,
    ...
    level_a_status = extract_heading_statement(closure_level_text, "Level A (program closure capability)")
    level_b_status = extract_heading_statement(closure_level_text, "Level B (program closure capability)")
