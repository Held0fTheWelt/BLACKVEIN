...
from app.services.inspector.inspector_turn_projection_sections_constants import (
    PLANNER_BOUND_STAGES,
    SEMANTIC_FLOW_STAGES,
    SUPPORT_NOTE_FULL_GOC,
    SUPPORT_NOTE_NON_GOC,
)
from app.services.inspector.inspector_turn_projection_sections_utils import non_empty_dict, non_empty_list
