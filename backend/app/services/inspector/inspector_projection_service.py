...
from app.services.ai_stack.ai_stack_evidence_service import build_session_evidence_bundle
from app.services.inspector.inspector_projection_comparison import (
    build_turn_comparisons,
    comparison_dimension_lists,
    session_has_candidate_matrix,
)
from app.services.inspector.inspector_projection_provenance_raw_entries import build_provenance_entries
from app.services.inspector.inspector_projection_shared import _build_root, _diagnostics_rows
from app.services.inspector.inspector_projection_turn_view import extract_turn_view
...
def build_inspector_coverage_health_projection(*, session_id: str, trace_id: str) -> dict[str, Any]:
    ...
    from app.services.inspector.inspector_projection_coverage_health import (
