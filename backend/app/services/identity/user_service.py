...
from app.services.identity.user_service_admin_guards import (
    ALLOWED_ASSIGN_ROLE_NAMES,
    assign_role_build_patch,
    ban_user_validate_actor,
    normalize_ban_reason,
)
from app.services.identity.user_service_update_guards import update_user_build_patch
...
def validate_email_format(email: str) -> tuple[bool, str]:
    ...
    try:
        ...
        # Keep "invalid" in the message so validation callers get a stable reason.
        error_msg = str(e)
...
def create_user(username, password, email=None):
    ...
    # accounts are verified at creation.
