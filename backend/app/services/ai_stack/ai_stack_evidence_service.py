...
from app.services.game.game_service import GameServiceError, get_story_diagnostics, get_story_state
from app.services.ai_stack.ai_stack_evidence_internals import (  # noqa: F401
...
def assemble_session_evidence_bundle(*, session_id: str, trace_id: str) -> dict[str, Any]:
    ...
    from app.services.ai_stack.ai_stack_evidence_session_bundle_sections import (
...
def build_release_readiness_report(*, trace_id: str) -> dict[str, Any]:
    ...
    from app.services.ai_stack.ai_stack_release_readiness_report import build_release_readiness_report_payload
