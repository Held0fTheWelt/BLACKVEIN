...
- schema/version alignment checks
...
from app.services.data.data_import_types import ImportIssue, ImportPreflightResult  # noqa: F401
from app.services.data.data_import_preflight import run_preflight_validate_payload as _run_preflight_validate_payload_impl
...
def preflight_validate_payload(payload: Dict[str, Any]) -> ImportPreflightResult:
    """Validate structure and schema alignment of a payload without writing to DB."""
