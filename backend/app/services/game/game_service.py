...
if __name__ == "app.services.game.game_service":
    sys.modules.setdefault("backend.app.services.game.game_service", sys.modules[__name__])
elif __name__ == "backend.app.services.game.game_service":
    sys.modules.setdefault("app.services.game.game_service", sys.modules[__name__])
...
def _enforce_governed_cost_budget_guard(*, provider_id: str | None, workflow_scope: str | None) -> None:
    try:
        ...
        from app.services.governance.governance_runtime_service import enforce_budget_guard
