...
def test_export_has_metadata(app):
    ...
    from app.services.data.data_export_service import export_full
    result = export_full()
...
def test_row_export_returns_single_row(app, test_user):
    ...
    from app.services.data.data_export_service import export_table_rows
...
def test_serialize_row_converts_datetime(app):
    ...
    from app.services.data.data_export_service import _serialize_row
    from datetime import datetime
...
def test_collect_rows_by_pk(app, test_user):
    ...
    from app.services.data.data_export_service import _collect_rows
    from app.extensions import db
    user_obj, _ = test_user
