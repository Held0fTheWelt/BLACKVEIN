...
_ARCHIVED_ARCHITECTURE = REPO_ROOT / "docs" / "archive" / "architecture-legacy"
...
def architecture_style_doc(name: str) -> Path:
    """Map an architecture-relative filename to an on-disk path."""
    ...
    return _ARCHIVED_ARCHITECTURE / name
