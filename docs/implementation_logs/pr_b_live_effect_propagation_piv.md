...
| Narrator consequence plan builder | [`ai_stack/narrator/narrator_consequence_contracts.py:169-243`](../../ai_stack/narrator/narrator_consequence_contracts.py) `build_narrator_consequence_plan()` | Returns `consequence_text`, `consequence_type`, `source`, `requires_model_realization`, `inferred_target`, `local_context_updated`, `affordances_available`, `transition_type`. | Reused unchanged. PR-B's realization contract is a downstream projection. |
...
| Newly verified for PR-B | `ai_stack/narrator/narrator_consequence_contracts.py:169-243` `build_narrator_consequence_plan()` (sets `requires_model_realization` at `:232`). | Verified. | Matches. |
...
- **Narrator consequence plan builder** at [`ai_stack/narrator/narrator_consequence_contracts.py:169-243`](../../ai_stack/narrator/narrator_consequence_contracts.py) — unchanged.
