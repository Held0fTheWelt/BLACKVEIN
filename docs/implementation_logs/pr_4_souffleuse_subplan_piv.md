# Sub-Plan 4 — Souffleuse increments (2026-05-20)
...
| PR-4E WS `FollowUpSemanticProvider` | Open | `ws_session_loop` accepts provider; world-engine must supply live provider |

Future PRs must run shadow judge on shipped opening outputs before enabling hard gate.
