...
| `docs/MVPs/MVP_VSL_And_GoC_Contracts/GATE_SCORING_POLICY_GOC.md` | gate shorthand as primary explanatory layer | shorthand-dominant exposition | add plain-language policy framing first, keep gate IDs secondary | P1 |
