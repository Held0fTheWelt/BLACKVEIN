# Task 2 — Protected Exception Registry (X1)

## Protected scope (narrow)
...
The following are explicitly not auto-protected:

- `docs/audit/gate_G9B_evaluator_independence_baseline.md`
- `docs/archive/superpowers-legacy-execution-2026/**` (archived execution-control sources; not curated active docs)
- `docs/mcp/*`
- other shorthand-heavy/process-heavy docs outside the X1 scope

## Control rule

X1 may not be used as a blanket reason to avoid readability cleanup or claim correction outside the protected scope listed above.
