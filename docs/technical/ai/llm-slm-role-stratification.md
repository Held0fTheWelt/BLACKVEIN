...
**Registry/routing convergence closure:** G-T2-01, G-T2-02, G-T2-03, G-T2-04, G-T2-05, G-T2-06, G-T2-07, G-T2-08 — [`registry_routing_convergence_gates.md`](../../archive/architecture-legacy/registry_routing_convergence_gates.md), [`registry_routing_convergence_closure_report.md`](../../archive/architecture-legacy/registry_routing_convergence_closure_report.md), [`convergence_gates.md`](../../archive/architecture-legacy/convergence_gates.md), [`operational_closure_gates.md`](../../archive/architecture-legacy/operational_closure_gates.md).

**Operator comparison closure:** G-T3-01, G-T3-02, G-T3-03, G-T3-04, G-T3-05, G-T3-06, G-T3-07, G-T3-08 — `compact_operator_comparison` grammar version **`operator_comparison_v1`**; tables [`operator_comparison_gates.md`](../../archive/architecture-legacy/operator_comparison_gates.md), [`operator_comparison_closure_report.md`](../../archive/architecture-legacy/operator_comparison_closure_report.md).

**Validation hardening closure:** G-T4-01, G-T4-02, G-T4-03, G-T4-04, G-T4-05, G-T4-06, G-T4-07, G-T4-08 — [`validation_hardening_gates.md`](../../archive/architecture-legacy/validation_hardening_gates.md), [`validation_hardening_closure_report.md`](../../archive/architecture-legacy/validation_hardening_closure_report.md). **Setup:** [`docs/testing-setup.md`](../../testing-setup.md) (validation hardening section embeds `task4_full_closure_pytest_invocation()` from `validation_commands`).

**Final operational closure:** G-FINAL-01, G-FINAL-02, G-FINAL-03, G-FINAL-04, G-FINAL-05, G-FINAL-06, G-FINAL-07, G-FINAL-08 — [`operational_closure_gates.md`](../../archive/architecture-legacy/operational_closure_gates.md), [`final_operational_closure_report.md`](../../archive/architecture-legacy/final_operational_closure_report.md).
