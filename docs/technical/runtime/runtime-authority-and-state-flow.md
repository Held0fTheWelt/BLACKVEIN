...
- [`meta_narrative_awareness_contract.md`](meta_narrative_awareness_contract.md) — bounded Pi25 opt-in meta-narrative awareness contract and structured validation
