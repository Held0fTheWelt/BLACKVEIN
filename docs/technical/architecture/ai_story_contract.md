...
**routing governance Task 4 formal closure (G-T4-01 … G-T4-08):** [`task4_closure_gates.md`](../../archive/architecture-legacy/task4_closure_gates.md) — binding terms and gate table. **Closure report:** [`validation_hardening_closure_report.md`](../../archive/architecture-legacy/validation_hardening_closure_report.md). **Canonical command list:** [`backend/app/runtime/validation_commands.py`](../../backend/app/runtime/validation_commands.py) (`TASK4_FULL_CLOSURE_PYTEST_MODULES`, `task4_full_closure_pytest_invocation`). **Tests:** `backend/tests/runtime/test_runtime_validation_commands_orchestration.py`. Setup: [`docs/testing-setup.md`](../../testing-setup.md) (routing governance Task 4 full closure section). **G-T4-01** E2E/integration truth across Runtime, Writers-Room, and Improvement; **G-T4-02** bootstrap/profile validation; **G-T4-03** cross-surface compact contract; **G-T4-04** negative/degraded honesty; **G-T4-05** drift resistance; **G-T4-06** validation-command reality; **G-T4-07** full proof-suite stability (subprocess); **G-T4-08** documentation truth.
...
Canonical Task 2A paths expose a single importable **authority map** (`routing_authority` — see [`backend/app/runtime/routing_authority.py`](../../backend/app/runtime/routing_authority.py)), deterministic **operational state** and **no-eligible discipline** (`operational_state`), and additive **`operator_audit.operator_truth`** (`operator_truth`) including **`legibility`** and **`canonical_authority_summary`**. Gates and outcomes: [`convergence_gates.md`](../../archive/architecture-legacy/convergence_gates.md), [`evolution_closure_report.md`](../../archive/architecture-legacy/evolution_closure_report.md). **Routing policy and authoritative Runtime semantics are unchanged.**
...
Final gates enforce **reproducible bootstrap** (named profiles), **healthy canonical paths** under `testing_bootstrap_on`, **authority convergence** in registry + summary text, **no-eligible non-normalization**, **operator legibility**, **cross-surface coherence**, **legacy compatibility**, and **documentation truth**. Table: [`final_closure_gates.md`](../../archive/architecture-legacy/final_closure_gates.md). PASS/FAIL and test commands: [`final_operational_closure_report.md`](../../archive/architecture-legacy/final_operational_closure_report.md). **Routing policy and authoritative Runtime semantics remain unchanged.**

### routing governance — Task 3 operator comparison and readability (G-T3-01, G-T3-02, G-T3-03, G-T3-04, G-T3-05, G-T3-06, G-T3-07, G-T3-08)

**`compact_operator_comparison`** under **`operator_audit.operator_truth`** provides a stable, cross-surface comparison grammar (`grammar_version` **`operator_comparison_v1`**) for operator-first reading: policy/execution posture, no-eligible meaning, unified selected-vs-executed rollup keys, stage outcome briefs, and explicit-null Runtime-only summaries on bounded paths. Gate table: [`task3_closure_gates.md`](../../archive/architecture-legacy/task3_closure_gates.md). Closure report: [`operator_comparison_closure_report.md`](../../archive/architecture-legacy/operator_comparison_closure_report.md). Tests: `backend/tests/runtime/test_task3_closure_gates.py`. **Routing policy and authoritative Runtime semantics remain unchanged.**

### routing governance — Task 2 registry/routing convergence (G-T2-01, G-T2-02, G-T2-03, G-T2-04, G-T2-05, G-T2-06, G-T2-07, G-T2-08)

Named closure over **registry/routing operational truth** for canonical Runtime, Writers-Room, and Improvement paths. Gate table: [`task2_closure_gates.md`](../../archive/architecture-legacy/task2_closure_gates.md). Closure report: [`registry_routing_convergence_closure_report.md`](../../archive/architecture-legacy/registry_routing_convergence_closure_report.md). Tests: `backend/tests/runtime/test_task2_closure_gates.py`. Authority registry: [`routing_authority.py`](../../backend/app/runtime/routing_authority.py). **Routing policy and authoritative Runtime semantics remain unchanged.**
