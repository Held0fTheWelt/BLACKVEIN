...
Plain-language entry to **Better Tomorrow** documentation. **World of Shadows** remains the subtitle and world/platform context. Read **one** path below based on your role, then use the [documentation registry](../reference/documentation-registry.md) for owners and maintenance. Longer easy-reading explainers live under [`docs/easy/`](../easy/README.md).

## Choose a path

| I am… | Read next |
|-------|-----------|
| New to the product | [What is Better Tomorrow?](what-is-world-of-shadows.md) → [How the system works](how-world-of-shadows-works.md) → [System map](system-map-services-and-data-stores.md) |
