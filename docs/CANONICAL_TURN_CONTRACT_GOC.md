...
Compatibility note: the primary normative home for this contract family is [`docs/MVPs/MVP_VSL_And_GoC_Contracts/CANONICAL_TURN_CONTRACT_GOC.md`](MVPs/MVP_VSL_And_GoC_Contracts/CANONICAL_TURN_CONTRACT_GOC.md). This root-level copy remains as a stable entrypoint, not as a second authority lane.
