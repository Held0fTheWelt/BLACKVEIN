...
4. **Visibility, status, freshness, action state, conflict resolution, validation failure codes** are closed enums (see `ai_stack/w5_actor_situation/models.py`).
...
- `ai_stack/w5_actor_situation/models.py` — closed enums and record models.
- `ai_stack/w5_actor_situation/extractor.py` — pure extractor.
