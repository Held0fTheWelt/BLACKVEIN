...
2. **Introduce `realization_plan.v1`** composed by `ai_stack/director_realization_composer.py` (`compose_realization_plan`). PR-A (movement) uses deterministic composition; PR-A.2/3 add semantic LLM composition and richer capabilities.
