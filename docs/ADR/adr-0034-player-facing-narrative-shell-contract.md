...
- `world-engine/app/story_runtime/manager/` (`_finalize_visible_blocks_with_goc_actor_split`, `_player_input_scene_blocks_for_story_window`, `_maybe_split_goc_opening_into_two_movements` — **not** `_annotate_goc_opening_narration_beats`, removed 2026-05)
- `ai_stack/story_runtime/god_of_carnage/god_of_carnage_opening_transition.py`, `ai_stack/story_runtime/narrator/god_of_carnage_narrator_path.py` (literary opening strings vs canonical `narration_beat` on blocks)
