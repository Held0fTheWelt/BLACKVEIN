...
- `ai_stack/npc_agency/goc_npc_transcript_projection.py`, `ai_stack/story_runtime/story_runtime_experience.py`, `ai_stack/goc_turn_seams.py` (`run_visible_render` diagnostics)
