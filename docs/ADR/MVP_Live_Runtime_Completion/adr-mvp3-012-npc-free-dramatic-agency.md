...
- `ai_stack/npc_agency_long_horizon.py` — deterministic `npc_long_horizon_state.v1`, `npc_intention_thread.v1`, `npc_private_plan.v1`, and `npc_plan_conflict_resolution.v1` builders.
- `ai_stack/npc_agency_claim_readiness.py` — evidence gate for bounded, live-staging-ready, and full long-horizon claim states.
