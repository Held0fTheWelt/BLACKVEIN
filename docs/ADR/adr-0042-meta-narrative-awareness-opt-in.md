...
- `PYTHONPATH=. python -m py_compile ai_stack/contracts/meta_narrative_awareness_contracts.py ai_stack/meta_narrative_awareness_engine.py ai_stack/story_runtime/story_runtime_experience.py ai_stack/module_runtime_policy.py ai_stack/runtime_aspect_ledger.py ai_stack/langgraph/langgraph_runtime_state.py ai_stack/langgraph/langgraph_runtime_executor.py`
