...
Implementation: `ai_stack/story_runtime/stream_readiness.classify_motivation_component_sources()`.
The autonomous-tick coordinator
(`ai_stack/story_runtime/autonomous_tick.AutonomousTickOutcome`) surfaces:
...
- `ai_stack/story_runtime/stream_readiness.py` —
  ...
  labelling).
- `ai_stack/story_runtime/autonomous_tick.py` — surfaces
