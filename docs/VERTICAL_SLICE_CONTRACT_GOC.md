...
Mirror-lane notice: this file is a stable-entry compatibility mirror, not an equal normative lane.
If wording diverges, the contract copy under `docs/MVPs/MVP_VSL_And_GoC_Contracts/` wins.

Compatibility note: the primary normative home for this contract family is [`docs/MVPs/MVP_VSL_And_GoC_Contracts/VERTICAL_SLICE_CONTRACT_GOC.md`](MVPs/MVP_VSL_And_GoC_Contracts/VERTICAL_SLICE_CONTRACT_GOC.md). This root-level copy remains as a stable entrypoint, not as a second authority lane.
