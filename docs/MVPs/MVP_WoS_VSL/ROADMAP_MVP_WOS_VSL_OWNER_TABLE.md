...
| **Primary slice contract** | [VERTICAL_SLICE_CONTRACT_GOC.md](../MVP_VSL_And_GoC_Contracts/VERTICAL_SLICE_CONTRACT_GOC.md) |
...
- [docs/MVPs/MVP_WoS_VSL/MVP_WOS_VSL_EXTERNAL_BLOCKERS.md](MVP_WOS_VSL_EXTERNAL_BLOCKERS.md)
