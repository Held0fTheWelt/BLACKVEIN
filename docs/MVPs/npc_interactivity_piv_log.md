...
| 4 | **PR-4B** | Full `character_voice_*.yaml` in souffleuse `source_facts` | **Merged (code)** | `goc_souffleuse.py` `_full_character_voice_profile` |
| W5 | **ADR-0063** | Optional `actor_locations` via W5 projection for gathering | **In flight** | `ai_stack/actor_situation/projection.py`, `test_phase1_live_wiring.py` |
