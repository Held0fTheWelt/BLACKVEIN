...
| QA / eval | Evaluation pipeline & judges | Langfuse-linked | partially_proven | ADR-006, ADR-009 | [`ai_stack/evaluation_pipeline.py`](../../ai_stack/evaluation_pipeline.py) |
...
| Operations | Operational gates | docker-up, `tests/run_tests.py`, CI | implemented | ADR-016 | [`docs/ADR/MVP_Live_Runtime_Completion/adr-mvp1-016-operational-gates.md`](../ADR/MVP_Live_Runtime_Completion/adr-mvp1-016-operational-gates.md); [`docs/ADR/MVP_Live_Runtime_Completion/adr-mvp2-016-operational-gates.md`](../ADR/MVP_Live_Runtime_Completion/adr-mvp2-016-operational-gates.md) |
