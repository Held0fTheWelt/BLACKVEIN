# Registry/Routing Convergence Gates

This document lists the closure gates for registry/routing convergence.
...
| G-T2-08 | registry/routing convergence docs and architecture cross-references list every G-T2 id and reference routing_authority. |
